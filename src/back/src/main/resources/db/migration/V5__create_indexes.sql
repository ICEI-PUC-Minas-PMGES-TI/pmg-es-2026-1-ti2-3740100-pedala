-- V5: Índices de performance (T-SQL - Azure SQL Server)
-- Sintaxe CREATE INDEX é igual ao MySQL — sem alteração necessária.
...
CREATE INDEX idx_rentals_pag_status   ON rentals(pagamento_status);
...
CREATE INDEX idx_insp_aluguel_id      ON inspections(aluguel_id);
